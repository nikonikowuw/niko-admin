...
var (
	...
	storage = map[string]map[int]string{
		"en": {
			...
			10042: "too many requests, please try again later",			20001: "unauthorized",
			20002: "token expired",
			20003: "invalid token",
		...
		"id": {
			...
			10042: "terlalu banyak permintaan, silakan coba lagi nanti",			20001: "tidak sah",
		...
		"ja": {
			...
			10042: "リクエストが多すぎます。後でもう一度お試しください",			20001: "認証されていません",
		...
		"ko": {
			...
			10042: "요청이 너무 많습니다. 나중에 다시 시도해 주세요",			20001: "인증되지 않았습니다",
			20002: "토큰이 만료되었습니다",
			20003: "유효하지 않은 토큰입니다",
