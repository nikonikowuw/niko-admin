export const roles = {
  ...
  form: {
    ...
    level: {
      ...
      helper:
        "Angka yang lebih rendah memberikan otoritas yang lebih tinggi; pemeriksaan izin akhir ditegakkan oleh backend.",
    },
  },
  modal: {
  ...
  message: {
    ...
    levelInvalidDescription:
      "Silakan masukkan angka bulat antara {{min}} dan {{max}}",
