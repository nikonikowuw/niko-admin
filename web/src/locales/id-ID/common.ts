export const common = {
  ...
  profile: {
    ...
    changePasswordHint: 'Untuk menjaga keamanan akun Anda, silakan ganti kata sandi Anda secara berkala',
    ...
    avatarCropHint: 'Gunakan roda mouse untuk memperbesar, seret untuk memposisikan ulang',
    updatePassword: 'Perbarui Kata Sandi',
    basicInfoHint: 'Kelola informasi pribadi Anda, termasuk nama tampilan dan email',
